...
public class StudentDetails extends JFrame implements ActionListener{
    ...
    JButton b1,b2,b3;
    JTextField t2;
    String x[] = {"Name","Father's Name","Age","Date of Birth","Address","Phone","Email","SSC GPA", "HSC GPA", "Batch No","Roll No","Program","Dept."};
