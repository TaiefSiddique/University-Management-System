...
import javax.swing.*;
import java.awt.*; ///eitar kaaj pore dhorte hbeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
...
public class FeeStructure extends JFrame{
    ...
    public FeeStructure(){
        ...
        i1 = new JLabel("Tution Fees");
        i1.setFont(new Font("Cambria",Font.ITALIC,56));
        i1.setBounds(670,10,400,70);
        add(i1);
