...
//        id15.setIcon(icc3);
        ...
        id8 = new JLabel("Add New Teacher Details");
        id8.setBounds(320,5,500,50);
        id8.setFont(new Font("Cambria",Font.BOLD,25));
        ...
        lab=new JLabel("Education Qualifications");
        lab.setBounds(50,400,150,30);
	lab.setFont(new Font("serif",Font.BOLD,15));
        id15.add(lab);
            
        String course[] = {"BSc","BBA","BA","BSS","LLM","MSc","MBA"};///BSc","BBA","BA","BSS","LLM","MSc","MBA
	...
	lab2.setFont(new Font("serif",Font.BOLD,20));
        ...
        String branch[] = {"CSE","EEE","TE","GBS","JMC","LLB", "Sociology","Economics"};//CSE","EEE","TE","GBS","JMC","LLB","Sociology","Economics
