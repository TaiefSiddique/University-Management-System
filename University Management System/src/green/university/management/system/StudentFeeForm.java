...
public class StudentFeeForm extends JFrame implements ActionListener{
	...
	JLabel l1 = new JLabel("Enter Id to Pay");
	...
	comboBox.setModel(new DefaultComboBoxModel(new String[] { "CSE", "EEE", "TE", "GBS", "JMC", "LLB", "Sociology","Economics" }));
	...
	comboBox_3.setModel(new DefaultComboBoxModel(
			new String[] { "BSc","BBA","BA","BSS","LLM","MSc","MBA" }));
