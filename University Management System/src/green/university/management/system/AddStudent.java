...
//        id15.setIcon(icc3);
        ...
        id8 = new JLabel("Add New Student Details");
        id8.setBounds(320,30,500,50);
        id8.setFont(new Font("Cambria",Font.BOLD,25));////////////////////////////ei line
        ...
        lab=new JLabel("Name Of Program");
	...
	lab2.setFont(new Font("serif",Font.BOLD,20));
        ...
        String branch[] = {"CSE","EEE","TE","GBS","JMC","LLB","Sociology","Economics"}; //GBS","JMC","LLB","Sociology","Economics
