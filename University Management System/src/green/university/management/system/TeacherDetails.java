...
public class TeacherDetails extends JFrame implements ActionListener{
    ...
    JButton b1,b2,b3;
    JTextField t2;
    String x[] = {"Name","Father's Name","Age","Date of Birth","Address","Phone No","Email","HSC GPA", "CGPA", "Session","Course","Department", "Employee Id"};
    ...
    TeacherDetails(){
        ...
        try{
            ...
            while(rs.next()){
                ...
                y[i][j++]=rs.getString("hsc");
                y[i][j++]=rs.getString("honours");
                y[i][j++]=rs.getString("session");
